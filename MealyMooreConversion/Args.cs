namespace MealyMooreConversion
{
    internal class Args
    {
        ...
        {
            if (!AvailableConversionTypes.Contains(ConversionType))
            {
        ...
        private ISet<string> AvailableConversionTypes = new HashSet<string> { Program.MEALY_TO_MOORE_CONVERSION_TYPE, Program.MOORE_TO_MEALY_CONVERSION_TYPE };
